...
public static class Permutations
{
    ...
    /// </returns>
    public static IEnumerable<IEnumerable<T>> Get<T>(IEnumerable<T> enumerables)
    {
        ...
        return enumerables.SelectMany(t =>
        Get(enumerables.Where(e => !e!.Equals(t))), (t1, t2) => new T[] { t1 }.Concat(t2));
    }
    ...
    /// If the input is null or empty, returns an empty sequence.
    /// </returns>
    public static IEnumerable<T> GetSingleList<T>(IEnumerable<T> enumerables)
    {
        IEnumerable<IEnumerable<T>> permutations = Get(enumerables);
